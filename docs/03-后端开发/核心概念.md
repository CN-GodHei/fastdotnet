...
- [实体设计](#🏗️-实体设计) - BaseEntity 和 AuditableEntity
- [仓储模式](#📦-仓储模式) - IRepository 接口详解
- [服务层](#🔧-服务层) - IBaseService 业务逻辑
- [工作单元](#unit-of-work) - IUnitOfWork 事务管理
- [控制器](#🎮-控制器) - GenericDtoControllerBase 快速开发
- [DTO 设计](#dto-design) - 数据传输对象规范
- [依赖注入](#💉-依赖注入) - 服务注册与使用
- [核心服务](#🔧-核心服务) - 缓存、日志、用户信息 ⭐
...
## 📋 DTO 设计 <span id="dto-design"></span>
