...
/** 根据实体主键批量更新实体信息 根据实体主键批量更新实体信息 PUT /api/admin/menu-buttons/batch */
export async function putAdminMenuButtonsBatch(body: APIModel.UpdateMenuButtonDto[], options?: { [key: string]: any }) {
...
/** 根据条件批量更新实体属性（部分字段更新） 根据条件批量更新实体属性（部分字段更新） PUT /api/admin/menu-buttons/batch/updatebycondition */
export async function putAdminMenuButtonsBatchUpdatebycondition(
	body: APIModel.UpdateMenuButtonDtoBatchUpdateByConditionDto,
	options?: { [key: string]: any }
) {
	return request<number>('/api/admin/menu-buttons/batch/updatebycondition', {
		method: 'PUT',
		headers: {
			'Content-Type': 'application/json-patch+json',
		},
