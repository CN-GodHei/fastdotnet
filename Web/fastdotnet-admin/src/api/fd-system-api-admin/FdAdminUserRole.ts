...
/** @deprecated 请使用 getGenericDtoControllerBase5GetAll，原函数名: getApiFdAdminUserRole */
...
export const getApiFdAdminUserRole = getGenericDtoControllerBase5GetAll;
/** 创建新记录 根据提供的数据创建一条新记录。 POST /api/FdAdminUserRole */
/** @deprecated 请使用 postGenericDtoControllerBase5Create，原函数名: postApiFdAdminUserRole */
export async function postGenericDtoControllerBase5Create(body: APIModel.CreateFdAdminUserRoleDto, options?: { [key: string]: any }) {
	return request<APIModel.FdAdminUserRoleDto>('/api/FdAdminUserRole', {
		method: 'POST',
		headers: {
...
export const postApiFdAdminUserRole = postGenericDtoControllerBase5Create;
/** 根据ID获取记录 根据提供的唯一标识符(ID)检索特定记录的详细信息。 GET /api/FdAdminUserRole/${param0} */
/** @deprecated 请使用 getGenericDtoControllerBase5GetById，原函数名: getApiFdAdminUserRoleId */
...
export const getApiFdAdminUserRoleId = getGenericDtoControllerBase5GetById;
/** 更新现有记录 根据提供的ID和更新数据，修改现有记录的信息。 PUT /api/FdAdminUserRole/${param0} */
/** @deprecated 请使用 putGenericDtoControllerBase5Update，原函数名: putApiFdAdminUserRoleId */
...
export const putApiFdAdminUserRoleId = putGenericDtoControllerBase5Update;
/** 删除记录 根据提供的ID，从系统中移除指定的记录。 DELETE /api/FdAdminUserRole/${param0} */
/** @deprecated 请使用 deleteGenericDtoControllerBase5Delete，原函数名: deleteApiFdAdminUserRoleId */
...
export const deleteApiFdAdminUserRoleId = deleteGenericDtoControllerBase5Delete;
/** 为用户分配角色（事务安全的一次性操作） POST /api/FdAdminUserRole/assign-roles */
/** @deprecated 请使用 postFdAdminUserRoleAssignUserRoles，原函数名: postApiFdAdminUserRoleAssignRoles */
export async function postFdAdminUserRoleAssignUserRoles(body: APIModel.AssignUserRolesDto, options?: { [key: string]: any }) {
...
/** @deprecated 此函数名已变更，请使用 postFdAdminUserRoleAssignUserRoles */
export const postApiFdAdminUserRoleAssignRoles = postFdAdminUserRoleAssignUserRoles;
/** 根据实体主键批量更新实体信息 根据实体主键批量更新实体信息 PUT /api/FdAdminUserRole/batch */
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateMany，原函数名: putApiFdAdminUserRoleBatch */
export async function putGenericDtoControllerBase5UpdateMany(body: APIModel.UpdateFdAdminUserRoleDto[], options?: { [key: string]: any }) {
...
export const putApiFdAdminUserRoleBatch = putGenericDtoControllerBase5UpdateMany;
/** 批量创建新记录 根据提供的数据批量创建新记录。 POST /api/FdAdminUserRole/batch */
/** @deprecated 请使用 postGenericDtoControllerBase5CreateMany，原函数名: postApiFdAdminUserRoleBatch */
export async function postGenericDtoControllerBase5CreateMany(body: APIModel.CreateFdAdminUserRoleDto[], options?: { [key: string]: any }) {
	return request<number>('/api/FdAdminUserRole/batch', {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json-patch+json',
...
export const postApiFdAdminUserRoleBatch = postGenericDtoControllerBase5CreateMany;
/** 批量删除记录 根据提供的ID列表，批量删除多条记录。 DELETE /api/FdAdminUserRole/batch */
/** @deprecated 请使用 deleteGenericDtoControllerBase5BatchDelete，原函数名: deleteApiFdAdminUserRoleBatch */
...
export const deleteApiFdAdminUserRoleBatch = deleteGenericDtoControllerBase5BatchDelete;
/** 根据条件批量更新实体属性（部分字段更新） 根据条件批量更新实体属性（部分字段更新） PUT /api/FdAdminUserRole/batch/updatebycondition */
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateManyByCondition，原函数名: putApiFdAdminUserRoleBatchUpdatebycondition */
...
export const putApiFdAdminUserRoleBatchUpdatebycondition = putGenericDtoControllerBase5UpdateManyByCondition;
/** 根据自定义条件获取列表(不分页) 根据自定义条件获取列表(不分页) POST /api/FdAdminUserRole/list-by-condition */
/** @deprecated 请使用 postGenericDtoControllerBase5GetListByCondition，原函数名: postApiFdAdminUserRoleListByCondition */
...
export const postApiFdAdminUserRoleListByCondition = postGenericDtoControllerBase5GetListByCondition;
/** 分页获取记录 根据页码和页面大小，分页检索记录。 GET /api/FdAdminUserRole/page */
/** @deprecated 请使用 getGenericDtoControllerBase5GetPage，原函数名: getApiFdAdminUserRolePage */
...
export const getApiFdAdminUserRolePage = getGenericDtoControllerBase5GetPage;
/** 根据条件分页获取记录 根据提供的查询条件和分页参数，分页检索记录。 POST /api/FdAdminUserRole/page/search */
/** @deprecated 请使用 postGenericDtoControllerBase5GetPageByCondition，原函数名: postApiFdAdminUserRolePageSearch */
...
export const postApiFdAdminUserRolePageSearch = postGenericDtoControllerBase5GetPageByCondition;
/** 获取回收站数据 检索并返回已软删除的记录（回收站数据）。 GET /api/FdAdminUserRole/recyclebin */
/** @deprecated 请使用 getGenericDtoControllerBase5GetRecycleBin，原函数名: getApiFdAdminUserRoleRecyclebin */
...
export const getApiFdAdminUserRoleRecyclebin = getGenericDtoControllerBase5GetRecycleBin;
/** 永久删除回收站中的记录 根据提供的ID，将已软删除的记录从数据库中永久移除。 DELETE /api/FdAdminUserRole/recyclebin/${param0}/permanent */
/** @deprecated 请使用 deleteGenericDtoControllerBase5PermanentDelete，原函数名: deleteApiFdAdminUserRoleRecyclebinIdPermanent */
...
export const deleteApiFdAdminUserRoleRecyclebinIdPermanent = deleteGenericDtoControllerBase5PermanentDelete;
/** 恢复回收站中的记录 根据提供的ID，将已软删除的记录恢复到正常状态。 PUT /api/FdAdminUserRole/recyclebin/${param0}/restore */
/** @deprecated 请使用 putGenericDtoControllerBase5Restore，原函数名: putApiFdAdminUserRoleRecyclebinIdRestore */
...
export const putApiFdAdminUserRoleRecyclebinIdRestore = putGenericDtoControllerBase5Restore;
/** 根据条件永久删除回收站中的记录 根据提供的条件，将回收站中符合条件的记录从数据库中永久移除。 POST /api/FdAdminUserRole/recyclebin/permanent */
/** @deprecated 请使用 postGenericDtoControllerBase5PermanentDeleteBatch，原函数名: postApiFdAdminUserRoleRecyclebinPermanent */
...
export const postApiFdAdminUserRoleRecyclebinPermanent = postGenericDtoControllerBase5PermanentDeleteBatch;
/** 批量恢复回收站中的记录 根据提供的条件，批量将回收站中的记录恢复到正常状态。 POST /api/FdAdminUserRole/recyclebin/restore */
/** @deprecated 请使用 postGenericDtoControllerBase5RestoreBatch，原函数名: postApiFdAdminUserRoleRecyclebinRestore */
...
export const postApiFdAdminUserRoleRecyclebinRestore = postGenericDtoControllerBase5RestoreBatch;
/** 根据条件查询回收站数据 根据提供的查询条件，检索回收站中的记录。 POST /api/FdAdminUserRole/recyclebin/search */
/** @deprecated 请使用 postGenericDtoControllerBase5SearchRecycleBin，原函数名: postApiFdAdminUserRoleRecyclebinSearch */
...
export const postApiFdAdminUserRoleRecyclebinSearch = postGenericDtoControllerBase5SearchRecycleBin;
/** 获取指定用户当前角色 GET /api/FdAdminUserRole/user/${param0}/roles */
/** @deprecated 请使用 getFdAdminUserRoleGetUserRoles，原函数名: getApiFdAdminUserRoleUserUserIdRoles */
export async function getFdAdminUserRoleGetUserRoles(
	// 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
	params: APIModel.getFdAdminUserRoleGetUserRolesParams,
	options?: { [key: string]: any }
) {
...
/** @deprecated 此函数名已变更，请使用 getFdAdminUserRoleGetUserRoles */
export const getApiFdAdminUserRoleUserUserIdRoles = getFdAdminUserRoleGetUserRoles;
