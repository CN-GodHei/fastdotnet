declare namespace APIModel {
	...
	type deleteFdAdminUserDeleteParams = {
		/** 要删除的记录的唯一标识符 */
		id: string;
	};

	type deleteFdMenuButtonsDeleteParams = {
		/** 要删除的记录的唯一标识符 */
		id: string;
	};

	type deleteFdMenuDeleteParams = {
		/** 要删除的记录的唯一标识符 */
		id: string;
	};

	type deleteFdRoleDeleteParams = {
		/** 要删除的记录的唯一标识符 */
		id: string;
	};

	type deleteGenericDtoControllerBase5DeleteParams = {
		/** 要删除的记录的唯一标识符 */
		id: string;
	};
	...
	type deleteGenericDtoControllerBase5PermanentDeleteParams = {
		/** 要永久删除的记录的唯一标识符 */
		id: string;
	};
	...
	type deleteOidcAppDeleteApplicationParams = {
		clientId: string;
	};
	...
	type getCodeGenDownloadFileParams = {
		/** 文件路径 */
		filePath?: string;
	};

	type getCodeGenGetColumnListByTableNameAndConfigIdParams = {
		/** 表名 */
		tableName: string;
		/** 配置ID */
		configId: string;
	...
	type getCodeGenGetTableListByConfigIdParams = {
		/** 配置ID */
		configId: string;
	};

	type getCodeGenPreviewCodeParams = {
		/** 代码生成配置ID */
		configId: string;
	...
	type getEncryptionKeyGetPrivateKeyParams = {
		/** 加密算法类型 */
		algorithm: string;
	};

	type getEncryptionKeyGetPublicKeyParams = {
		/** 加密算法类型 */
		algorithm: string;
	};

	type getFdAdminUserGetPageParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getFdAdminUserRoleGetUserRolesParams = {
		userId: string;
	};

	type getFdAppUserRoleGetUserRolesParams = {
		userId: string;
	};
	...
	type getFdBlacklistsIsBlacklistedParams = {
		type?: string;
		value?: string;
	};

	type getFdMenuButtonsGetByIdParams = {
		/** 记录的唯一标识符 */
		id: string;
	};

	type getFdMenuButtonsGetPageParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getFdMenuGetByIdParams = {
		/** 记录的唯一标识符 */
		id: string;
	};

	type getFdMenuGetMenuBtnParams = {
		Belong?: number;
		RoleId?: string;
	};

	type getFdMenuGetPageParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getFdNationalStandardGetStandardDetailParams = {
		standardCode: string;
	};

	type getFdNationalStandardGetStandardTreeParams = {
		standardCode: string;
	};

	type getFdRatelimitRuleGetByTypeAndKeyParams = {
		type?: string;
		key?: string;
	};

	type getFdRatelimitRuleIsRateLimitedParams = {
		type?: string;
		key?: string;
	};

	type getFdRoleGetByIdParams = {
		/** 记录的唯一标识符 */
		id: string;
	};

	type getFdRoleGetPageParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getFdRoleGetPermissionIdsParams = {
		id: string;
	};

	type getFdWorkbenchGetCardRolesParams = {
		cardId: string;
	};

	type getFdWorkbenchGetRoleCardsParams = {
		roleId: string;
	};

	type getGenericDtoControllerBase5GetByIdParams = {
		/** 记录的唯一标识符 */
		id: string;
	};
	...
	type getGenericDtoControllerBase5GetPageParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getGenericDtoControllerBase5GetRecycleBinParams = {
		/** 页码 (从1开始) */
		pageIndex?: number;
		/** 页面大小 */
		pageSize?: number;
	...
	type getOidcAppGetApplicationParams = {
		clientId: string;
	};
	...
	type getPluginConfigurationGetPluginConfigurationByIdParams = {
		PluginId: string;
	};

	type getPluginIsPluginActiveParams = {
		pluginId: string;
	};
	...
	type postFdAdminUserResetPasswordParams = {
		id: string;
	};
	...
	type postFdNationalStandardUpdateVersionParams = {
		standardCode: string;
	};

	type postFdNoticeMarkAsReadParams = {
		id: string;
	};

	type postFdRoleAssignPermissionsParams = {
		id: string;
	};

	type postFdRoleSaveParams = {
		id: string;
	};

	type postFdTodoTaskCompleteParams = {
		id: string;
	};

	type postFdTodoTaskTransferParams = {
		id: string;
		newAssigneeId: string;
	};

	type postFdWorkbenchAssignParams = {
		roleId: string;
	};

	type postFdWorkbenchUpdateCardRolesParams = {
		cardId: string;
	};

	type postOidcAppResetSecretParams = {
		clientId: string;
	};
	...
	type postPluginDisablePluginParams = {
		pluginId: string;
	};

	type postPluginEnablePluginParams = {
		pluginId: string;
	};

	type postPluginUninstallPluginParams = {
		pluginId: string;
	};
	...
	type putFdMenuButtonsUpdateParams = {
		/** 要更新的记录的唯一标识符 */
		id: string;
	};

	type putFdMenuUpdateParams = {
		/** 要更新的记录的唯一标识符 */
		id: string;
	};

	type putFdRoleUpdateParams = {
		/** 要更新的记录的唯一标识符 */
		id: string;
	};

	type putGenericDtoControllerBase5RestoreParams = {
		/** 要恢复的记录的唯一标识符 */
		id: string;
	};
	...
	type putGenericDtoControllerBase5UpdateParams = {
		/** 要更新的记录的唯一标识符 */
		id: string;
	};
	...
	type putPluginConfigurationUpdateParams = {
		PluginId: string;
	};
