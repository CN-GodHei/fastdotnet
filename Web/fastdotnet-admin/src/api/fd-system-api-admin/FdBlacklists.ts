...
/** @deprecated 请使用 getGenericDtoControllerBase5GetAll，原函数名: getApiAdminFdBlacklists */
...
export const getApiAdminFdBlacklists = getGenericDtoControllerBase5GetAll;
/** 创建新记录 根据提供的数据创建一条新记录。 POST /api/admin/FdBlacklists */
/** @deprecated 请使用 postGenericDtoControllerBase5Create，原函数名: postApiAdminFdBlacklists */
export async function postGenericDtoControllerBase5Create(body: APIModel.CreateFdBlacklistDto, options?: { [key: string]: any }) {
	return request<APIModel.FdBlacklistDto>('/api/admin/FdBlacklists', {
		method: 'POST',
		headers: {
...
export const postApiAdminFdBlacklists = postGenericDtoControllerBase5Create;
/** 根据ID获取记录 根据提供的唯一标识符(ID)检索特定记录的详细信息。 GET /api/admin/FdBlacklists/${param0} */
/** @deprecated 请使用 getGenericDtoControllerBase5GetById，原函数名: getApiAdminFdBlacklistsId */
...
export const getApiAdminFdBlacklistsId = getGenericDtoControllerBase5GetById;
/** 更新现有记录 根据提供的ID和更新数据，修改现有记录的信息。 PUT /api/admin/FdBlacklists/${param0} */
/** @deprecated 请使用 putGenericDtoControllerBase5Update，原函数名: putApiAdminFdBlacklistsId */
...
export const putApiAdminFdBlacklistsId = putGenericDtoControllerBase5Update;
/** 删除记录 根据提供的ID，从系统中移除指定的记录。 DELETE /api/admin/FdBlacklists/${param0} */
/** @deprecated 请使用 deleteGenericDtoControllerBase5Delete，原函数名: deleteApiAdminFdBlacklistsId */
...
export const deleteApiAdminFdBlacklistsId = deleteGenericDtoControllerBase5Delete;
/** 根据实体主键批量更新实体信息 根据实体主键批量更新实体信息 PUT /api/admin/FdBlacklists/batch */
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateMany，原函数名: putApiAdminFdBlacklistsBatch */
export async function putGenericDtoControllerBase5UpdateMany(body: APIModel.UpdateFdBlacklistDto[], options?: { [key: string]: any }) {
...
export const putApiAdminFdBlacklistsBatch = putGenericDtoControllerBase5UpdateMany;
/** 批量创建新记录 根据提供的数据批量创建新记录。 POST /api/admin/FdBlacklists/batch */
/** @deprecated 请使用 postGenericDtoControllerBase5CreateMany，原函数名: postApiAdminFdBlacklistsBatch */
export async function postGenericDtoControllerBase5CreateMany(body: APIModel.CreateFdBlacklistDto[], options?: { [key: string]: any }) {
	return request<number>('/api/admin/FdBlacklists/batch', {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json-patch+json',
...
export const postApiAdminFdBlacklistsBatch = postGenericDtoControllerBase5CreateMany;
/** 批量删除记录 根据提供的ID列表，批量删除多条记录。 DELETE /api/admin/FdBlacklists/batch */
/** @deprecated 请使用 deleteGenericDtoControllerBase5BatchDelete，原函数名: deleteApiAdminFdBlacklistsBatch */
...
export const deleteApiAdminFdBlacklistsBatch = deleteGenericDtoControllerBase5BatchDelete;
/** 根据条件批量更新实体属性（部分字段更新） 根据条件批量更新实体属性（部分字段更新） PUT /api/admin/FdBlacklists/batch/updatebycondition */
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateManyByCondition，原函数名: putApiAdminFdBlacklistsBatchUpdatebycondition */
export async function putGenericDtoControllerBase5UpdateManyByCondition(
	body: APIModel.BatchUpdateByConditionDto1UpdateFdBlacklistDto,
	options?: { [key: string]: any }
) {
...
export const putApiAdminFdBlacklistsBatchUpdatebycondition = putGenericDtoControllerBase5UpdateManyByCondition;
/** 检查值是否在黑名单中 GET /api/admin/FdBlacklists/check */
/** @deprecated 请使用 getFdBlacklistsIsBlacklisted，原函数名: getApiAdminFdBlacklistsCheck */
export async function getFdBlacklistsIsBlacklisted(
	// 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
	params: APIModel.getFdBlacklistsIsBlacklistedParams,
	options?: { [key: string]: any }
) {
...
/** @deprecated 此函数名已变更，请使用 getFdBlacklistsIsBlacklisted */
export const getApiAdminFdBlacklistsCheck = getFdBlacklistsIsBlacklisted;
/** 根据自定义条件获取列表(不分页) 根据自定义条件获取列表(不分页) POST /api/admin/FdBlacklists/list-by-condition */
/** @deprecated 请使用 postGenericDtoControllerBase5GetListByCondition，原函数名: postApiAdminFdBlacklistsListByCondition */
export async function postGenericDtoControllerBase5GetListByCondition(body: APIModel.QueryByConditionDto, options?: { [key: string]: any }) {
	return request<any>('/api/admin/FdBlacklists/list-by-condition', {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json-patch+json',
		},
...
export const postApiAdminFdBlacklistsListByCondition = postGenericDtoControllerBase5GetListByCondition;
/** 分页获取记录 根据页码和页面大小，分页检索记录。 GET /api/admin/FdBlacklists/page */
/** @deprecated 请使用 getGenericDtoControllerBase5GetPage，原函数名: getApiAdminFdBlacklistsPage */
...
export const getApiAdminFdBlacklistsPage = getGenericDtoControllerBase5GetPage;
/** 根据条件分页获取记录 根据提供的查询条件和分页参数，分页检索记录。 POST /api/admin/FdBlacklists/page/search */
/** @deprecated 请使用 postGenericDtoControllerBase5GetPageByCondition，原函数名: postApiAdminFdBlacklistsPageSearch */
...
export const postApiAdminFdBlacklistsPageSearch = postGenericDtoControllerBase5GetPageByCondition;
/** 获取回收站数据 检索并返回已软删除的记录（回收站数据）。 GET /api/admin/FdBlacklists/recyclebin */
/** @deprecated 请使用 getGenericDtoControllerBase5GetRecycleBin，原函数名: getApiAdminFdBlacklistsRecyclebin */
...
export const getApiAdminFdBlacklistsRecyclebin = getGenericDtoControllerBase5GetRecycleBin;
/** 永久删除回收站中的记录 根据提供的ID，将已软删除的记录从数据库中永久移除。 DELETE /api/admin/FdBlacklists/recyclebin/${param0}/permanent */
/** @deprecated 请使用 deleteGenericDtoControllerBase5PermanentDelete，原函数名: deleteApiAdminFdBlacklistsRecyclebinIdPermanent */
...
export const deleteApiAdminFdBlacklistsRecyclebinIdPermanent = deleteGenericDtoControllerBase5PermanentDelete;
/** 恢复回收站中的记录 根据提供的ID，将已软删除的记录恢复到正常状态。 PUT /api/admin/FdBlacklists/recyclebin/${param0}/restore */
/** @deprecated 请使用 putGenericDtoControllerBase5Restore，原函数名: putApiAdminFdBlacklistsRecyclebinIdRestore */
...
export const putApiAdminFdBlacklistsRecyclebinIdRestore = putGenericDtoControllerBase5Restore;
/** 根据条件永久删除回收站中的记录 根据提供的条件，将回收站中符合条件的记录从数据库中永久移除。 POST /api/admin/FdBlacklists/recyclebin/permanent */
/** @deprecated 请使用 postGenericDtoControllerBase5PermanentDeleteBatch，原函数名: postApiAdminFdBlacklistsRecyclebinPermanent */
export async function postGenericDtoControllerBase5PermanentDeleteBatch(
	body: APIModel.Expression1Func2FdBlacklist_SystemBooleanSystemPrivateCoreLibVersion10000Cultureneutral,
	options?: { [key: string]: any }
) {
...
export const postApiAdminFdBlacklistsRecyclebinPermanent = postGenericDtoControllerBase5PermanentDeleteBatch;
/** 批量恢复回收站中的记录 根据提供的条件，批量将回收站中的记录恢复到正常状态。 POST /api/admin/FdBlacklists/recyclebin/restore */
/** @deprecated 请使用 postGenericDtoControllerBase5RestoreBatch，原函数名: postApiAdminFdBlacklistsRecyclebinRestore */
...
export const postApiAdminFdBlacklistsRecyclebinRestore = postGenericDtoControllerBase5RestoreBatch;
/** 根据条件查询回收站数据 根据提供的查询条件，检索回收站中的记录。 POST /api/admin/FdBlacklists/recyclebin/search */
/** @deprecated 请使用 postGenericDtoControllerBase5SearchRecycleBin，原函数名: postApiAdminFdBlacklistsRecyclebinSearch */
...
export const postApiAdminFdBlacklistsRecyclebinSearch = postGenericDtoControllerBase5SearchRecycleBin;
