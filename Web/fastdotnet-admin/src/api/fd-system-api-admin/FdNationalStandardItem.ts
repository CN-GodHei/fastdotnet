...
/** @deprecated 请使用 getGenericDtoControllerBase5GetAll，原函数名: getApiFdNationalStandardItem */
...
/** @deprecated 请使用 postGenericDtoControllerBase5Create，原函数名: postApiFdNationalStandardItem */
...
/** @deprecated 请使用 getGenericDtoControllerBase5GetById，原函数名: getApiFdNationalStandardItemId */
...
/** @deprecated 请使用 putGenericDtoControllerBase5Update，原函数名: putApiFdNationalStandardItemId */
...
/** @deprecated 请使用 deleteGenericDtoControllerBase5Delete，原函数名: deleteApiFdNationalStandardItemId */
...
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateMany，原函数名: putApiFdNationalStandardItemBatch */
...
/** @deprecated 请使用 postGenericDtoControllerBase5CreateMany，原函数名: postApiFdNationalStandardItemBatch */
...
/** @deprecated 请使用 deleteGenericDtoControllerBase5BatchDelete，原函数名: deleteApiFdNationalStandardItemBatch */
...
/** @deprecated 请使用 putGenericDtoControllerBase5UpdateManyByCondition，原函数名: putApiFdNationalStandardItemBatchUpdatebycondition */
...
/** @deprecated 请使用 postGenericDtoControllerBase5GetListByCondition，原函数名: postApiFdNationalStandardItemListByCondition */
...
/** @deprecated 请使用 getGenericDtoControllerBase5GetPage，原函数名: getApiFdNationalStandardItemPage */
...
/** @deprecated 请使用 postGenericDtoControllerBase5GetPageByCondition，原函数名: postApiFdNationalStandardItemPageSearch */
...
/** @deprecated 请使用 getGenericDtoControllerBase5GetRecycleBin，原函数名: getApiFdNationalStandardItemRecyclebin */
...
/** @deprecated 请使用 deleteGenericDtoControllerBase5PermanentDelete，原函数名: deleteApiFdNationalStandardItemRecyclebinIdPermanent */
...
/** @deprecated 请使用 putGenericDtoControllerBase5Restore，原函数名: putApiFdNationalStandardItemRecyclebinIdRestore */
...
/** @deprecated 请使用 postGenericDtoControllerBase5PermanentDeleteBatch，原函数名: postApiFdNationalStandardItemRecyclebinPermanent */
...
/** @deprecated 请使用 postGenericDtoControllerBase5RestoreBatch，原函数名: postApiFdNationalStandardItemRecyclebinRestore */
...
/** @deprecated 请使用 postGenericDtoControllerBase5SearchRecycleBin，原函数名: postApiFdNationalStandardItemRecyclebinSearch */
