	...
	<div class="fdratelimitrule-container">
			...
			<el-form :model="state.queryParams" ref="queryForm" :inline="true">
				<div v-show="state.searchCollapsed">
					...
					<el-form-item label="Key" prop="Key">
						<el-input placeholder="请输入Key" clearable v-model="state.queryParams.Key" style="width: 150px" />
					</el-form-item>
					<el-form-item label="PermitLimit" prop="PermitLimit">
						<el-input placeholder="请输入PermitLimit" clearable v-model="state.queryParams.PermitLimit" style="width: 150px" />
					</el-form-item>
					<el-form-item label="WindowSeconds" prop="WindowSeconds">
						<el-input placeholder="请输入WindowSeconds" clearable v-model="state.queryParams.WindowSeconds" style="width: 150px" />
					</el-form-item>
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 5px">
			...
			<el-table :data="state.tableData.data" style="width: 100%" v-loading="state.loading" border>
				...
				<el-table-column prop="Key" label="Key" align="center" show-overflow-tooltip />
				<el-table-column prop="PermitLimit" label="PermitLimit" align="center" show-overflow-tooltip />
				<el-table-column prop="WindowSeconds" label="WindowSeconds" align="center" show-overflow-tooltip />
		...
		<el-dialog v-model="state.dialog.visible" draggable :close-on-click-modal="false" width="700px">
			...
			<el-form :model="state.formData" ref="formRef" label-width="auto">
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="Type" prop="Type">
						<el-input v-model="state.formData.Type" placeholder="请输入Type" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="Key" prop="Key">
						<el-input v-model="state.formData.Key" placeholder="请输入Key" maxlength="255" show-word-limit clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="PermitLimit" prop="PermitLimit">
						<el-input v-model="state.formData.PermitLimit" placeholder="请输入PermitLimit" clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="WindowSeconds" prop="WindowSeconds">
						<el-input v-model="state.formData.WindowSeconds" placeholder="请输入WindowSeconds" clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					<el-form-item label="Description" prop="Description">
	...
	try {
		...
		const queryConfig = {
			customs: [
				...
				{ field: 'Key', operator: 'eq', value: state.queryParams.Key },
				{ field: 'PermitLimit', operator: 'eq', value: state.queryParams.PermitLimit },
				{ field: 'WindowSeconds', operator: 'eq', value: state.queryParams.WindowSeconds },
...
const openAddDialog = () => {
	...
	state.dialog.title = '新增fd_ratelimit_rule';
...
const openEditDialog = (row: any) => {
	state.dialog.visible = true;
	state.dialog.title = '编辑fd_ratelimit_rule';
	state.formData = { ...row };
};
...
.fdratelimitrule-container .el-card:first-child .el-form .el-form-item:last-of-type {
