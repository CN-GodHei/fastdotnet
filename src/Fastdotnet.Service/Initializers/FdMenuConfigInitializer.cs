...
{
    new FdMenu { Name = "控制台", Code = "MENU_CODE_11365281228129285", Path = "/dashboard", Icon = "string", Sort = 0, Type = MenuType.Menu, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = null, IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false,ParentCode=null },

    new FdMenu { Name = "系统管理", Code = "MENU_CODE_11365290021618693", Path = "/system", Icon = "string", Sort = 0, Type = 0, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = null, IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode=null},
    ...
    new FdMenu { Name = "Plugin A", Code = "MENU_CODE_11375905679934469", Path = "/micro/plugin-a", Icon = "ele-Monitor", Sort = 100, Type = 0, Module = "PluginA", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "layout/routerView/parent.vue", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode=null},

    new FdMenu { Name = "Plugin A Home", Code = "MENU_CODE_11375910391972869", Path = "/micro/plugin-a", Icon = "ele-HomeFilled", Sort = 1, Type = MenuType.Menu, Module = "PluginA", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode="MENU_CODE_11375905679934469"},

    new FdMenu { Name = "Plugin A About", Code = "MENU_CODE_11375913497723909", Path = "/micro/plugin-a/about", Icon = "ele-InfoFilled", Sort = 2, Type = MenuType.Menu, Module = "PluginA", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode="MENU_CODE_11375905679934469"}
};
