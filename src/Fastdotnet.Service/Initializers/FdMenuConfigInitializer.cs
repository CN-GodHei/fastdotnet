            ...
            var configs = new List<FdMenu>
{
    ...
    new FdMenu { Name = "Plugin A Home", Code = "MENU_CODE_11375910391972869", Path = "/app-plugin-a", Icon = "ele-HomeFilled", Sort = 1, Type = MenuType.Menu, Module = "PluginA", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode="MENU_CODE_11375905679934469"},
