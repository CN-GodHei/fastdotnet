...
export default defineConfig(({ mode }) => {
  return {
    plugins: [
      ...
      // 构建完成后复制 micro-index.html 到发布目录并重命名为 index.html
      {
        ...
        closeBundle() {
          ...
          const outFile = path.resolve(__dirname, '../../publish/11375910391972869/wwwroot/app/index.html')
    ...
    build: {
      outDir: '../../publish/11375910391972869/wwwroot/app',  // 输出到发布目录
      emptyOutDir: true,  // 构建前清空输出目录
      lib: {
        name: '11375910391972869',
        entry: path.resolve(__dirname, 'src/micro-main.ts'),
        formats: ['umd'],
        fileName: () => `11375910391972869-app.js`
      },
      rollupOptions: {
