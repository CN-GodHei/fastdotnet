...
namespace PluginA.Initializers
{
    public class FdMenuConfigInitializer : IApplicationInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            new FdMenu {Title="富文本编辑器演示", Name = "", Code = "MENU_CODE_11375913497723911", Path = "/micro/11375910391972869/rich-text-demo", Icon = "ele-Edit", Sort = 3, Type = MenuType.Menu, Module = "plugin-a", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode="MENU_CODE_11375905679934469",PluginId="11375910391972869"},
            //new FdMenu {Title="富文本插件演示", Name = "", Code = "MENU_CODE_11375913497723912", Path = "/micro/11375910391972869/rich-text-plugin-demo", Icon = "ele-Document", Sort = 4, Type = MenuType.Menu, Module = "plugin-a", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode="MENU_CODE_11375905679934469",PluginId="11375910391972869"},
            //new FdMenu {Title="表单集成富文本", Name = "", Code = "MENU_CODE_11375913497723913", Path = "/micro/11375910391972869/form-with-richtext", Icon = "ele-List", Sort = 5, Type = MenuType.Menu, Module = "plugin-a", Category = "Admin", IsExternal = false, ExternalUrl = "", IsEnabled = true, PermissionCode = "", Component = "", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = true ,ParentCode="MENU_CODE_11375905679934469",PluginId="11375910391972869"},
            };
