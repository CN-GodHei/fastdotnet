...
namespace Fastdotnet.Core.Controllers
{
        ...
        where TUpdateDto : class
    {
        ...
        protected AppGenericDtoControllerBase(IBaseService<TEntity, TKey> service)
        {
            _service = service;
        }
        /// <summary>
    ...
    public abstract class AppGenericDtoControllerBase<TEntity, TCreateDto, TUpdateDto, TDto> : AppGenericDtoControllerBase<TEntity, string, TCreateDto, TUpdateDto, TDto>
        ...
        where TUpdateDto : class
    {
        protected AppGenericDtoControllerBase(IBaseService<TEntity, string> service, ICurrentUser currentUser) : base(service, currentUser)
        {
        }
        protected AppGenericDtoControllerBase(IBaseService<TEntity, string> service) : base(service)
        {
        }
    }
}