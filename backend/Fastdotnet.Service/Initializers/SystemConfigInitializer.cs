            ...
            var configs = new List<SystemConfig>
{
    ...
    // ========== 布局配置抽屉 ==========
    new SystemConfig { Name = "是否开启布局配置抽屉", Code = "isDrawer", Value = false, Description = "控制是否显示主题配置抽屉面板", IsSystem = true },

    // ========== 全局主题 ==========
    new SystemConfig { Name = "默认 primary 主题颜色", Code = "primary", Value = "#0F59A4", Description = "系统主色调，影响按钮、选中态等UI元素", IsSystem = true },
    new SystemConfig { Name = "是否开启深色模式", Code = "isIsDark", Value = false, Description = "启用深色主题模式", IsSystem = true },

    // ========== 顶栏设置 ==========
    new SystemConfig { Name = "默认顶栏导航背景颜色", Code = "topBar", Value = "#ffffff", Description = "顶部导航栏背景色", IsSystem = true },
    new SystemConfig { Name = "默认顶栏导航字体颜色", Code = "topBarColor", Value = "#606266", Description = "顶部导航栏文字颜色", IsSystem = true },
    new SystemConfig { Name = "是否开启顶栏背景颜色渐变", Code = "isTopBarColorGradual", Value = false, Description = "顶栏背景是否使用渐变色", IsSystem = true },

    // ========== 菜单设置 ==========
    new SystemConfig { Name = "默认菜单导航背景颜色", Code = "menuBar", Value = "#545c64", Description = "侧边菜单栏背景色", IsSystem = true },
    new SystemConfig { Name = "默认菜单导航字体颜色", Code = "menuBarColor", Value = "#eaeaea", Description = "侧边菜单栏文字颜色", IsSystem = true },
    new SystemConfig { Name = "默认菜单高亮背景色", Code = "menuBarActiveColor", Value = "rgba(0, 0, 0, 0.2)", Description = "菜单项激活/选中时的背景色", IsSystem = true },
    new SystemConfig { Name = "是否开启菜单背景颜色渐变", Code = "isMenuBarColorGradual", Value = false, Description = "菜单栏背景是否使用渐变色", IsSystem = true },

    // ========== 分栏设置 ==========
    new SystemConfig { Name = "默认分栏菜单背景颜色", Code = "columnsMenuBar", Value = "#545c64", Description = "分栏布局下菜单背景色", IsSystem = true },
    new SystemConfig { Name = "默认分栏菜单字体颜色", Code = "columnsMenuBarColor", Value = "#e6e6e6", Description = "分栏布局下菜单文字颜色", IsSystem = true },
    new SystemConfig { Name = "是否开启分栏菜单背景颜色渐变", Code = "isColumnsMenuBarColorGradual", Value = false, Description = "分栏菜单背景是否使用渐变色", IsSystem = true },
    new SystemConfig { Name = "是否开启分栏菜单鼠标悬停预加载", Code = "isColumnsMenuHoverPreload", Value = false, Description = "分栏菜单悬停时是否预加载子菜单", IsSystem = true },

    // ========== 界面设置 ==========
    new SystemConfig { Name = "是否开启菜单水平折叠效果", Code = "isCollapse", Value = false, Description = "菜单是否默认折叠", IsSystem = true },
    new SystemConfig { Name = "是否开启菜单手风琴效果", Code = "isUniqueOpened", Value = true, Description = "是否只允许同时展开一个菜单项", IsSystem = true },
    ...
    new SystemConfig { Name = "初始化变量（勿删）", Code = "isShowLogoChange", Value = false, Description = "用于 el-scrollbar 高度更新，请勿删除", IsSystem = true },
    new SystemConfig { Name = "是否开启 Breadcrumb", Code = "isBreadcrumb", Value = true, Description = "是否显示顶部面包屑导航", IsSystem = true },
    new SystemConfig { Name = "是否开启 Tagsview", Code = "isTagsview", Value = true, Description = "是否启用顶部标签页导航", IsSystem = true },
    new SystemConfig { Name = "是否开启 Breadcrumb 图标", Code = "isBreadcrumbIcon", Value = false, Description = "面包屑是否显示图标", IsSystem = true },
    new SystemConfig { Name = "是否开启 Tagsview 图标", Code = "isTagsviewIcon", Value = false, Description = "标签页是否显示图标", IsSystem = true },
    new SystemConfig { Name = "是否开启 TagsView 缓存", Code = "isCacheTagsView", Value = false, Description = "标签页是否缓存已打开页面", IsSystem = true },
    new SystemConfig { Name = "是否开启 TagsView 拖拽", Code = "isSortableTagsView", Value = true, Description = "标签页是否支持拖拽排序", IsSystem = true },
    new SystemConfig { Name = "是否开启 TagsView 共用", Code = "isShareTagsView", Value = false, Description = "多标签页是否跨路由共享", IsSystem = true },
    new SystemConfig { Name = "是否开启 Footer 底部版权信息", Code = "isFooter", Value = true, Description = "页面底部是否显示版权信息栏", IsSystem = true },
    ...
    new SystemConfig { Name = "主页面切换动画", Code = "animation", Value = "slide-right", Description = "页面切换动画，可选值：slide-right / slide-left / opacitys", IsSystem = true },
    new SystemConfig { Name = "分栏高亮风格", Code = "columnsAsideStyle", Value = "columns-round", Description = "分栏菜单高亮样式，可选值：columns-round / columns-card", IsSystem = true },
    new SystemConfig { Name = "分栏布局风格", Code = "columnsAsideLayout", Value = "columns-vertical", Description = "分栏菜单布局方向，可选值：columns-horizontal / vertical", IsSystem = true },

    // ========== 布局切换 ==========
    new SystemConfig { Name = "布局切换", Code = "layout", Value = "defaults", Description = "系统布局模式，可选值：defaults / classic / transverse / columns", IsSystem = true },

    // ========== 后端控制路由 ==========
    new SystemConfig { Name = "是否开启后端控制路由", Code = "isRequestRoutes", Value = true, Description = "是否由后端返回动态路由菜单结构", IsSystem = true },
