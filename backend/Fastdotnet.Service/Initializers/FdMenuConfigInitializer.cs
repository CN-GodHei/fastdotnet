    ...
    public class FdMenuConfigInitializer : IApplicationInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            var AdminMenu = new List<FdMenu>
            {
                ...
                new FdMenu {Title="管理员", Name = "FdAdminUser", Code = "MENU_CODE_12198088013579269", Path = "/system/adminuser", Icon = "string", Sort = 0, Type = MenuType.Menu, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = "/system/adminuser/index.vue", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode="MENU_CODE_11365290021618693"},
                ...
                new FdMenu {Title="代码生成", Name = "sysCodeGen", Code = "MENU_CODE_11365291745215491", Path = "/dev/fdtemplate", Icon = "string", Sort = 0, Type = MenuType.Menu, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = "/dev/fdtemplate/index.vue", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode="MENU_CODE_11365290021618692"},
                new FdMenu {Title="生成测试", Name = "FdAdminUser1", Code = "MENU_CODE_11365291745215494", Path = "/dev/fdtemplatetest", Icon = "string", Sort = 0, Type = MenuType.Menu, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = "/dev/fdtemplate/test.vue", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode="MENU_CODE_11365290021618692"},
                
                //应用端菜单
                new FdMenu {Title="应用端管理", Name = "", Code = "MENU_CODE_12294151568819205", Path = "/systemapp", Icon = "iconfont icon-putong", Sort = 1, Type = 0, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = null, IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode=null},
                new FdMenu {Title="用户管理", Name = "FdAppUser", Code = "MENU_CODE_12294159076557829", Path = "/system/appuser", Icon = "string", Sort = 0, Type = MenuType.Menu, Module = "string", Category = "Admin", IsExternal = false, ExternalUrl = "string", IsEnabled = true, PermissionCode = "string", Component = "/system/user/index.vue", IsHide = false, IsKeepAlive = true, IsAffix = false, IsIframe = false, IsFdMicroApp = false ,ParentCode="MENU_CODE_12294151568819205"},
            };
